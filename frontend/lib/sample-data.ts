...
export const demoData: SeedData = {
  workspaces: [
    {
      id: 'ws_teamflow',
      name: 'TeamFlow HQ',
  ...
  meetings: [
    {
      ...
      description: 'Finalize sprint scope and assign ownership for top priorities.',
      workspaceId: 'ws_teamflow',
      projectId: 'proj_sprintcore',
      organizerId: 'mem_olivia',
      attendeeIds: ['mem_olivia', 'mem_mason', 'mem_ava'],
      startAt: daysAgo(-1),
      durationMinutes: 45,
      meetingLink: 'https://meet.google.com/teamflow-sync',
      status: 'scheduled',
      createdAt: daysAgo(1),
      updatedAt: daysAgo(1)
    }
  ...
  notifications: [
    {
      ...
      message: 'Explore your new dashboard and start managing projects.',
